...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-cneter justify-center min-w-96 mx-auto">
      <div
...
//                         <span className='text-base label-text'>Username</span>
//                     </label>
//                     <input type='text' placeholder='jhohndoe' className='w-full input input-bordered h-10'/>
//                 </div>
